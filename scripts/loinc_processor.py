...
## Input/Loinc.csv
loinc = pd.read_csv('inputs\Loinc.csv')
...
file_output_path = 'outputs/loinc_small.csv'

loinc_small.to_csv('outputs/loinc_small.csv')

loinc_small.to_csv('outputs/loinc_small.csv_noindex.csv', index=False)